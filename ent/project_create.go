...
func (pc *ProjectCreate) SetRegion(s string) *ProjectCreate {
	pc.mutation.SetRegion(s)
	return pc
}

// SetKpsEnabled sets the "kps_enabled" field.
func (pc *ProjectCreate) SetKpsEnabled(b bool) *ProjectCreate {
	pc.mutation.SetKpsEnabled(b)
	return pc
}
...
func (pc *ProjectCreate) check() error {
	...
	if _, ok := pc.mutation.Region(); !ok {
		return &ValidationError{Name: "region", err: errors.New(`ent: missing required field "Project.region"`)}
	}
	if _, ok := pc.mutation.KpsEnabled(); !ok {
		return &ValidationError{Name: "kps_enabled", err: errors.New(`ent: missing required field "Project.kps_enabled"`)}
	}
	return nil
}
...
func (pc *ProjectCreate) createSpec() (*Project, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.KpsEnabled(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: project.FieldKpsEnabled,
		})
		_node.KpsEnabled = value
	}
	return _node, _spec
}
